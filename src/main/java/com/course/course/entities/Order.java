...
import com.course.course.entities.enuns.OrderStatus;
...
public class Order implements Serializable {
    ...
    @OneToOne(mappedBy = "order", cascade = CascadeType.ALL) // no caso de 1to1, o cascade mapeia o memso id para os dois
